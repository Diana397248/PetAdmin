...
watch(() => props.editData, (newVal) => {
    if (newVal) {
        ...
        selectedEditVet.value = newVal.vet;
    }
}, {immediate: true});
...
const submitEditForm = async () => {
    ...
    const formData = {
        ...
        vet_id: selectedEditVet.value.id,
...
const setVetId = () => {
    if (selectedEditVet.value) {
        errors.value.vet_id = [];
        editForm.vet_id = selectedEditVet.value.id;
    }
};
...
watch(selectedEditVet, () => {
    if (selectedEditVet.value) {
        setVetId();
    } else {
        editForm.vet_id = null;
    }
    validateForm(editForm);
});
                            ...
                            <form @submit.prevent="submitEditForm" class="py-5">
                                <div class="grid gap-4 mb-4 grid-cols-2">
                                    <div class="col-span-2">
                                        ...
                                        <VueMultiselect v-model="selectedEditVet" :options="props.matchingVets"
                                                        :multiple="false"
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <VueMultiselect v-model="selectedEditClient" :options="props.matchingClients"
                                                        :multiple="false"
                                                        :clear-on-select="true" placeholder="Type to search"
                                                        label="name" track-by="id"
