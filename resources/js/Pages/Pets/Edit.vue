            ...
            <form @submit.prevent="editPet" enctype="multipart/form-data" class="space-y-5">
                <div class="grid grid-cols-12 gap-5">
                    <div class="col-span-6">
                        <label for="name" class="mb-2 block text-sm font-medium text-gray-500">Имя</label>
                    ...
                    <div class="col-span-12 sm:col-span-6">
                        <label for="species" class="mb-2 block text-sm font-medium text-gray-500">Разновидность</label>
                        <VueMultiselect v-model="selectedSpecies"
                                        :class="{ 'error': errors.species_id }"
                                        :options="matchingSpecies" :multiple="false" :clear-on-select="true"
                    ...
                    <div class="col-span-12 sm:col-span-6">
                        <label for="breed" class="mb-2 block text-sm font-medium text-gray-500">Порода</label>
                    ...
                    <div class="col-span-8 sm:col-span-10">
                        <label for="gender" class="mb-2 block text-sm font-medium text-gray-500">Пол</label>
                        <select v-model="editForm.gender" id="gender"
                            ...
                            <option disabled selected>Выбрать пол</option>
                    ...
                    <div class="col-span-4 sm:col-span-2">
                        <label for="age" class="mb-2 block text-sm font-medium text-gray-500">Возраст</label>
                    ...
                    <div class="col-span-12">
                        <div class="mx-auto max-w-full">
                            <label for="photo" class="mb-2 block text-sm font-medium text-gray-500">Фото домашнего
                                животного</label>
                            <label @dragover.prevent @drop.prevent="handleFileDrop"
                                ...
                                <div class="space-y-1 text-center">
                                    <div
                                        ...
                                        <img v-if="editForm.photo && editForm.photo.url" :src="editForm.photo.url"
                                             alt="Pet Photo" class="h-20 w-20 rounded-full"/>
                                        <div v-else>
