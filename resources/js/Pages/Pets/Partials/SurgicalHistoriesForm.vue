...
import {errors, validateForm, watchFields} from '@/Validation/Pets/SurgicalHistories/Index';
...
<template>
    <div class="max-w-full bg-white rounded-md mt-2">
        ...
        <div class="text-lg font-semibold leading-6 text-gray-900 border-b p-6 flex justify-between items-center">
            Surgical History
            <button @click.stop.prevent="addSurgery"
        ...
        <form @submit.prevent="storeSurgery" class="mt-6">
            ...
            <div v-for="(surgery, index) in surgeriesForm" :key="index" class="grid grid-cols-12 gap-5 mb-5 p-5">
                <div class=" col-span-12 md:col-span-6 lg:col-span-2">
                    <label for="procedure_name" class="mb-2 block text-sm font-medium text-gray-500">Название
                        процедуры</label>
                ...
                <div class="col-span-12 md:col-span-8 lg:col-span-3">
                    <DoctorSelect v-model="surgery.surgeon"/>
