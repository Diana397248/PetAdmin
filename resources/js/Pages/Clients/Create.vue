...
<template>
  <AppLayout title="Добавление клиента">
    <template #header>
        ...
        <form @submit.prevent="submitForm">
          <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
            <div class="sm:col-span-2">
              <label for="name" class="block mb-2 text-xs font-medium text-gray-400 dark:text-white">Имя клиента</label>
            ...
            <div class="w-full">
              <label for="email" class="block mb-2 text-xs font-medium text-gray-400 dark:text-white">Почта</label>
            ...
            <div class="w-full">
              <label for="phone_number" class="block mb-2 text-xs font-medium text-gray-400 dark:text-white">Номер телефона</label>
            ...
            <div class="sm:col-span-2">
              <label for="address" class="block mb-2 text-xs font-medium text-gray-400 dark:text-white">Адрес</label>
            ...
            <div class="sm:col-span-2">
              <label for="notes"
                class="block mb-2 text-xs font-medium text-gray-400 dark:text-white">Описание</label>
              <textarea v-model="createForm.notes" name="notes" id="notes" rows="8"
                ...
                placeholder="Я люблю животных..."></textarea>
